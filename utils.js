...
export function normalizeSpotlightCountry(settings) {
    let country = settings.get_string('spotlight-country').trim().toUpperCase();
    if (country === '') {
        settings.reset('spotlight-country');
        return settings.get_string('spotlight-country');
    }
    if (country !== settings.get_string('spotlight-country'))
        settings.set_string('spotlight-country', country);
    return country;
}
